...
// Re-exported so every existing `from './InvestigatorTranscript.js'`
// import keeps working; the definitions moved to keep this file's
// stylesheet out of the GoatTown entry point.
export {
  applyLoopEvent,
  type InvestigatorAssistantEntry,
  type InvestigatorErrorEntry,
